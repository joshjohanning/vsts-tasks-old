...
import * as prca from 'tfsgit-pr-injector/PrcaOrchestrator';
import { PrcaOrchestrator } from 'tfsgit-pr-injector/PrcaOrchestrator';
...
var token: string = '';
//var repositoryName: string = tl.getVariable('Build.Repository.Name');
